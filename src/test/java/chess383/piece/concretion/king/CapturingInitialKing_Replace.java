/*
 *  CapturingInitialKing_Replace.java
 *
...
/**
 * <p>
 * The class CapturingInitialKing_Replace implements an upper tester
 * </p>
 *
 * @author    Jörg Dippel
 * @version   June 2020
 *
 */
@DisplayName("the public method MovedKing replace( ) for class InitialKing is tested for capturings")
public class CapturingInitialKing_Replace {  
    
    @ParameterizedTest( name = "given a standard board a king from location {0} moved to location {1} the capturings must match {2}" )
