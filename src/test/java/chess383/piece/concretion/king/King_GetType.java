...
/**
 * <p>
 * The class King_GetType implements an upper tester
 * </p>
 *
 * @author    Jörg Dippel
 * @version   July 2020
 *
 */
@DisplayName("the public method String getType( ) for class King is tested")
public class King_GetType {    
    ...
    public static Stream<Arguments> dictionaryProvider() {
        return Stream.of(
            ...
            Arguments.of( "K", Locale.GERMAN )
          , Arguments.of( "K", Locale.GERMANY )
          , Arguments.of( "k", Locale.ENGLISH )
          , Arguments.of( "K", Locale.KOREA )        // will be redirected to default
    ...
    public void returnDefaultName() {
    	...
    	assertThat( "K" ).as( "default dictionary entry should fit" ).isEqualTo( piece.getType() );
    }
}
