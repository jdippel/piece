...
/**
 * <p>
 * The class Queen_GetType.java implements an upper tester
 * </p>
 *
 * @author    Jörg Dippel
 * @version   July 2020
 *
 */
@DisplayName("the public method String getType( ) for class Queen is tested")
public class Queen_GetType {    
    ...
    public static Stream<Arguments> dictionaryProvider() {
        return Stream.of(
            ...
            Arguments.of( "D", Locale.GERMAN )
          , Arguments.of( "D", Locale.GERMANY )
          , Arguments.of( "q", Locale.ENGLISH )
          , Arguments.of( "D", Locale.KOREA )        // will be redirected to default
    ...
    public void returnDefaultName() {
    	...
    	assertThat( "D" ).as( "default dictionary entry should fit" ).isEqualTo( piece.getType() );
    }
}
