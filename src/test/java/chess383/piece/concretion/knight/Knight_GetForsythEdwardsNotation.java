/*
 *  Knight_GetForsythEdwardsNotation.java
 *
...
/**
 * <p>
 * The class Knight_GetForsythEdwardsNotation implements an upper tester
 * </p>
 *
 * @author    Jörg Dippel
 ...
 *
 */
@DisplayName("the public method Character getForsythEdwardsNotation() for class Knight is tested")
public class Knight_GetForsythEdwardsNotation {    
    
    @Test
    @DisplayName("for an initial black pawn the FEN abbreviation ignoring upper/lower case should match the given abrreviation")
    public void getForsythEdwardsNotation_WhenGivenKnight_ThenTheFENAbbreviationMatches() {
        
        final Character FEN_DESCRIPTION = 'n';
