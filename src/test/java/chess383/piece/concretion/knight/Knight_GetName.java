...
/**
 * <p>
 * The class Knight_GetName implements an upper tester
 * </p>
 *
 * @author    Jörg Dippel
 * @version   July 2020
 *
 */
@DisplayName("the public method String getName( ) for class Knight is tested")
public class Knight_GetName {    
    ...
    public static Stream<Arguments> dictionaryProvider() {
        return Stream.of(
            ...
            Arguments.of( "Springer", Locale.GERMAN )
          , Arguments.of( "Springer", Locale.GERMANY )
          , Arguments.of( "knight", Locale.ENGLISH )
          , Arguments.of( "Springer", Locale.KOREA )        // will be redirected to default
    ...
    public void returnDefaultName() {
    	...
    	assertThat( "Springer" ).as( "default dictionary entry should fit" ).isEqualTo( piece.getName() );
    }
}
