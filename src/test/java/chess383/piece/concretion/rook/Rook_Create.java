...
/**
 * <p>
 * The class Rook_Create implements an upper tester
 * </p>
 *
 * @author    Jörg Dippel
 ...
 *
 */
@DisplayName("the public method Rook create( ) for class Rook is tested")
public class Rook_Create {  
    ...
    public static Stream<Arguments> stringAndListProvider() {
        return Stream.of(
            ...
            Arguments.of( "e4", Arrays.asList( "e4 e5 e6 e7 e8", "e4 f4 g4 h4", "e4 e3 e2 e1", "e4 d4 c4 b4 a4" ) ),
            Arguments.of( "h4", Arrays.asList( "h4 h5 h6 h7 h8", "h4 h3 h2 h1", "h4 g4 f4 e4 d4 c4 b4 a4" ) )
