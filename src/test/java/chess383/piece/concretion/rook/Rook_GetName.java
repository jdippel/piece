...
/**
 * <p>
 * The class Rook_GetName implements an upper tester
 * </p>
 *
 * @author    Jörg Dippel
 * @version   July 2020
 *
 */
@DisplayName("the public method String getName( ) for class Rook is tested")
public class Rook_GetName {    
    ...
    public static Stream<Arguments> dictionaryProvider() {
        return Stream.of(
            ...
            Arguments.of( "Turm", Locale.GERMAN )
          , Arguments.of( "Turm", Locale.GERMANY )
          , Arguments.of( "rook", Locale.ENGLISH )
          , Arguments.of( "Turm", Locale.KOREA )        // will be redirected to default
    ...
    public void returnDefaultName() {
    	...
    	assertThat( "Turm" ).as( "default dictionary entry should fit" ).isEqualTo( piece.getName() );
    }
}
