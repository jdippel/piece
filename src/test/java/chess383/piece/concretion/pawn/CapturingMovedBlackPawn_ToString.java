/*
 *  CapturingMovedBlackPawn_ToString.java
 *
...
/**
 * <p>
 * The class CapturingMovedBlackPawn_ToString implements an upper tester
 * </p>
 *
 * @author    Jörg Dippel
 ...
 *
 */
@DisplayName("the public method String toString( ) for class MovedBlackPawn is tested for capturing")
public class CapturingMovedBlackPawn_ToString {     
    ...
    public void testWithMultiArgMethodSource_ForDelegation( String origin, List<String> expectedResultList ) {
        ...
        MovedBlackPawn piece = MovedBlackPawn.create( origin );
    ...
    public void testWithMultiArgMethodSource_ForPieceName( String origin, List<String> expectedResultList ) {
        ...
        Piece.createBoard( ICoordinateFactory.STANDARD.get( ) );
        String PIECE_NAME = "moved black pawn";
        MovedBlackPawn piece = MovedBlackPawn.create( origin );
    ...
    public static Stream<Arguments> stringAndListProvider() {
        return Stream.of(
            ...
            Arguments.of( "e5", Arrays.asList( "e5 d4", "e5 f4" ) ),
