/*
 *  MovingMovedWhitePawn_ToString.java
 *
...
/**
 * <p>
 * The class MovingMovedWhitePawn_ToString implements an upper tester
 * </p>
 *
 * @author    Jörg Dippel
 ...
 *
 */
@DisplayName("the public method String toString( ) for class MovedWhitePawn is tested for moving")
public class MovingMovedWhitePawn_ToString {    
    ...
    public void testWithMultiArgMethodSource_ForDelegation( String origin, List<String> expectedResultList ) {
        ...
        MovedWhitePawn piece = MovedWhitePawn.create( origin );
    ...
    public void testWithMultiArgMethodSource_ForPieceName( String origin, List<String> expectedResultList ) {
        ...
        Piece.createBoard( ICoordinateFactory.STANDARD.get( ) );
        String PIECE_NAME = "moved white pawn";
        MovedWhitePawn piece = MovedWhitePawn.create( origin );
    ...
    public static Stream<Arguments> stringAndListProvider() {
        return Stream.of(
            ...
            Arguments.of( "e5", Arrays.asList( "e5 e6" ) ),
