/*
 *  MovingMovedWhitePawn_Replace.java
 *
...
/**
 * <p>
 * The class MovingMovedWhitePawn_Replace implements an upper tester
 * </p>
 *
 * @author    Jörg Dippel
 * @version   June 2020
 *
 */
@DisplayName("the public method MovedWhitePawn create( ) for class MovedWhitePawn is tested for moving")
public class MovingMovedWhitePawn_Replace {  
    ...
    public void testWithMultiArgMethodSource_ForMovings( String origin, String target, List<String> expectedResultList ) {
        ...
        MovedWhitePawn piece = MovedWhitePawn.create( origin ).replace( target );
    ...
    public static Stream<Arguments> stringAndStringAndListProvider() {
        return Stream.of(
            ...
            Arguments.of( "e4", "e5", Arrays.asList( "e5 e6" ) ),
            Arguments.of( "e7", "e8", EMPTY_STRING_LIST )
