/*
 *  MovingInitialWhitePawn_Create.java
 *
...
/**
 * <p>
 * The class MovingInitialWhitePawn_Create implements an upper tester
 * </p>
 *
 * @author    Jörg Dippel
 ...
 *
 */
@DisplayName("the public method InitialWhitePawn create( ) for class InitialWhitePawn is tested for moving")
public class MovingInitialWhitePawn_Create {    
    ...
    public static Stream<Arguments> stringAndListProvider() {
        return Stream.of(
            ...
            Arguments.of( "e2", Arrays.asList( "e2 e3 e4" ) ),
