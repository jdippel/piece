/*
 *  MovingMovedBlackPawn_ToString.java
 *
...
/**
 * <p>
 * The class MovingMovedBlackPawn_ToString implements an upper tester
 * </p>
 *
 * @author    Jörg Dippel
 ...
 *
 */
@DisplayName("the public method String toString( ) for class MovedBlackPawn is tested for moving")
public class MovingMovedBlackPawn_ToString {    
    ...
    public static Stream<Arguments> stringAndListProvider() {
        return Stream.of(
            ...
            Arguments.of( "e5", Arrays.asList( "e5 e4" ) ),
