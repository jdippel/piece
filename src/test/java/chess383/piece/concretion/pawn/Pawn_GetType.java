...
/**
 * <p>
 * The class Pawn_GetType implements an upper tester
 * </p>
 *
 * @author    Jörg Dippel
 * @version   August 2020
 *
 */
@DisplayName("the public method String getType( ) for class Pawn is tested")
public class Pawn_GetType {    
    ...
    public static Stream<Arguments> dictionaryProvider() {
        return Stream.of(
            ...
            Arguments.of( " ", Locale.GERMAN )
          , Arguments.of( " ", Locale.GERMANY )
          , Arguments.of( " ", Locale.ENGLISH )
          , Arguments.of( " ", Locale.KOREA )        // will be redirected to default
    ...
    public void returnDefaultNameForMovedBlackPawn() {
    	...
    	assertThat( " " ).as( "default dictionary entry should fit" ).isEqualTo( piece.getType() );
    }
