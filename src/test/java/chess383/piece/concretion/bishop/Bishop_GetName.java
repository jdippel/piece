...
/**
 * <p>
 * The class Bishop_GetName implements an upper tester
 * </p>
 *
 * @author    Jörg Dippel
 * @version   July 2020
 *
 */
@DisplayName("the public method String getName( ) for class Bishop is tested")
public class Bishop_GetName {    
    ...
    public static Stream<Arguments> dictionaryProvider() {
        return Stream.of(
            ...
            Arguments.of( "Läufer", Locale.GERMAN )
          , Arguments.of( "Läufer", Locale.GERMANY )
          , Arguments.of( "bishop", Locale.ENGLISH )
          , Arguments.of( "Läufer", Locale.KOREA )        // will be redirected to default
    ...
    public void returnDefaultName() {
    	...
    	assertThat( "Läufer" ).as( "default dictionary entry should fit" ).isEqualTo( piece.getName() );
    }
}
