...
/**
 * <p>
 * The class Bishop_ToString implements an upper tester
 * </p>
 *
 * @author    Jörg Dippel
 ...
 *
 */
@DisplayName("the public method String toString( ) for class Bishop is tested")
public class Bishop_ToString {  
    ...
    public static Stream<Arguments> stringAndListProvider() {
        return Stream.of(
            ...
            Arguments.of( "e4", Arrays.asList( "e4 d3 c2 b1", "e4 d5 c6 b7 a8", "e4 f3 g2 h1", "e4 f5 g6 h7" ) ),
