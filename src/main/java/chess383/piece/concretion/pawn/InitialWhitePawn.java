 ...
 *
 */
public class InitialWhitePawn extends WhitePawn {
    ...
    private InitialWhitePawn( String location ) {
    ...
    public static InitialWhitePawn create( String location ) {
        
        InitialWhitePawn result = new InitialWhitePawn( location );
    ...
    public String toString() {
        ...
        return( "initial white pawn: " + super.toString() );
    }
}
